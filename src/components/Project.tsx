    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/tursunait/udacity-ab-testing" target="_blank" rel="noreferrer"><img src={mock00} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/ericiortega/ids705-phishing-detection" target="_blank" rel="noreferrer"><img src={mock04} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/tursunait/Cloud-Hosted-Notebook-Data-Manipulation-Tursunai" target="_blank" rel="noreferrer"><img src={mock05} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/tursunait/Databricks_Urbanization_Analysis_And_Dashboard" target="_blank" rel="noreferrer"><img src={mock07} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/tursunait/py_script_with_SQLDatabase" target="_blank" rel="noreferrer"><img src={mock06} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/Afag-Ramazanova/AskSQL-Natural-Language-to-SQL-query-converter" target="_blank" rel="noreferrer"><img src={mock01} className="zoom" alt="thumbnail" width="100%"/></a>
